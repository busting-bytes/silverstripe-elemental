...
use App\Chiesi\Framework\Extensions\OnlyForPractitionersExtension;
...
class ElementalAreaField extends GridField
{
    ...
    public function saveInto(DataObjectInterface $dataObject)
    {
        ...
        foreach ($elementData as $form => $data) {
            ...
            if (isset($data["Visibility"]) && $data["Visibility"]!==$element->Visibility) {
                OnlyForPractitionersExtension::$elementsUpdated = true;
            }
